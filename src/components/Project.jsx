...
const Project = () => {
  return (
      <>
        <div className='max-w-screen-xl px-14 max-[900px]:px-0 mx-auto pb-24 max-[900px]:pb-8 max-[900px]:pt-5 bg-[#f2f2f2]'>
        <div className='flex items-center justify-center gap-12 ml-20 max-[900px]:ml-0 '>
          <div className='flex items-center justify-center gap-4 '>
        <h1 className='tracking-wider uppercase text-[3.8vw] max-[900px]:text-[5vw] font-[400] text-[#212121] font-[Satoshi Light]'>feat proj<span className='font-[Migra] font-[400] italic text-[4.2vw] max-[900px]:text-[5.4vw] max-[900px]:mr-1  text-[#603ae1] mr-2'>ec</span>ts</h1>  
    ...
    <div className='flex flex-col justify-center w-[40vw] gap-4 relative'>
        <div className='w-[45vw]  overflow-hidden hover:scale-[0.94] ease-in-out duration-300 cursor-pointer relative group'>
         ...
         <div className='flex items-center justify-end mt-[-5%] px-14 max-[900px]:mt-4 max-[900px]:px-[2.3em] '>
    <div className='flex flex-col justify-center w-[40vw] gap-4 relative'>
        <div className='w-[45vw]  overflow-hidden hover:scale-[0.94] ease-in-out duration-300 cursor-pointer relative group'>
...
<div className='flex flex-col justify-center w-[45vw] gap-4 mt-[-5%] max-[900px]:mt-4 max-[900px]:px-[1em] '>
    <div className='flex flex-col justify-center w-[40vw] gap-4 relative'>
        <div className='w-[45vw]  overflow-hidden hover:scale-[0.94] ease-in-out duration-300 cursor-pointer relative group'>
...
<div className='flex items-center justify-end  mt-[-5%] max-[900px]:mt-4 px-14 max-[900px]:px-[2.3em]'>
    <div className='flex flex-col justify-center w-[40vw] gap-4 relative'>
        <div className='w-[45vw]  overflow-hidden hover:scale-[0.94] ease-in-out duration-300 cursor-pointer relative group'>
