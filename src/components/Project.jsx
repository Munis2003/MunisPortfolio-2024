  ...
  return (
    <>
      <div className='max-w-screen-xl relative px-14 max-[900px]:px-[1.2em] mx-auto pb-24 max-[900px]:pb-8 max-[900px]:pt-5 bg-[#f2f2f2]'>
        ...
        <svg className="o-ui-arrow rotate-90 stroke-[#212121]/40 ml-[80.1%] max-[900px]:ml-[90.1%] max-[900px]:w-[25px] max-[900px]:h-[25px]" width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='flex flex-col justify-center w-[45vw] gap-4 max-[900px]:mt-[-3%] '>
          <div className='flex flex-col justify-center w-[40vw] gap-4 relative'>
            <div className='w-[45vw] overflow-hidden hover:scale-[0.94] ease-in-out duration-300 cursor-pointer relative group'>
              <img className='overflow-hidden h-3xl w-3xl object-cover' src={SMWZMockup} alt="SMWZ" />
              <button className='absolute inset-0 flex items-center justify-center bg-[#212121] bg-opacity-50 text-[#f2f2f2] opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
                ...
                <a target='_blank' href="https://github.com/Munis2003/SMWZ-MOVIE-WEBAPP">
                  <button className='max-[900px]:hidden absolute top-[85%] left-[5%] flex items-center gap-3 border-[1.2px] border-[#f2f2f2]/30 py-1 rounded-3xl p-2 text-[14px] font-[Satoshi Light]'>
                    View source code <i className="ri-github-fill text-[20px]"></i>
                  </button>
                </a>
              </button>
            </div>
        ...
        <div className='flex items-center justify-end px-14 max-[900px]:mt-4 max-[900px]:px-[1.2em]'>
          <div className='flex flex-col justify-center w-[40vw] gap-4 relative'>
            <div className='w-[45vw] overflow-hidden hover:scale-[0.94] ease-in-out duration-300 cursor-pointer relative group'>
              <img className='overflow-hidden h-3xl w-3xl object-cover' src={ChatMateMockup} alt="Chat Mate" />
              <button className='absolute inset-0 flex items-center justify-center bg-[#212121] bg-opacity-50 text-[#f2f2f2] opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
                ...
                <a target='_blank' href="https://github.com/Munis2003/ChatMate/tree/main">
                  <button className='absolute top-[85%] left-[5%] max-[900px]:hidden flex items-center gap-3 border-[1.2px] border-[#f2f2f2]/30 py-1 rounded-3xl p-2 text-[14px] font-[Satoshi Light]'>
                    View source code <i className="ri-github-fill text-[20px]"></i>
                  </button>
                </a>
              </button>
        ...
        <div className='flex flex-col justify-center w-[45vw] gap-4  max-[900px]:mt-4 max-[900px]:px-0 '>
          <div className='flex flex-col justify-center w-[40vw] gap-4 relative'>
            <div className='w-[45vw] overflow-hidden hover:scale-[0.94] ease-in-out duration-300 cursor-pointer relative group'>
              <img className='overflow-hidden h-3xl w-3xl object-cover' src={CrypTrackerMockup} alt="Cryp Tracker" />
              <button className='absolute inset-0 flex items-center justify-center bg-[#212121] bg-opacity-50 text-[#f2f2f2] opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
                ...
                <a target='_blank' href="https://github.com/Munis2003/CrypTracker">
                  <button className='max-[900px]:hidden absolute top-[85%] left-[5%] flex items-center gap-3 border-[1.2px] border-[#f2f2f2]/30 py-1 rounded-3xl p-2 text-[14px] font-[Satoshi Light]'>
                    View source code <i className="ri-github-fill text-[20px]"></i>
                  </button>
                </a>
        ...
        <div className='flex items-center justify-end max-[900px]:mt-4 px-14 max-[900px]:px-[1.2em] '>
          <div className='flex flex-col justify-center w-[40vw] gap-4 relative'>
            <div className='w-[45vw] overflow-hidden hover:scale-[0.94] ease-in-out duration-300 cursor-pointer relative group'>
              <img className='overflow-hidden h-3xl w-3xl object-cover' src={MuseSphereMockup} alt="Muse Sphere" />
              <button className='absolute inset-0 flex items-center justify-center bg-[#212121] bg-opacity-50 text-[#f2f2f2] opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
                ...
                <a target='_blank' href="https://github.com/Munis2003/MuseSphere">
                  <button className='max-[900px]:hidden absolute top-[85%] left-[5%] flex items-center gap-3 border-[1.2px] border-[#f2f2f2]/30 py-1 rounded-3xl p-2 text-[14px] font-[Satoshi Light]'>
                    View source code <i className="ri-github-fill text-[20px]"></i>
                  </button>
                </a>
