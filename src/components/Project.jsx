...
const Project = () => {
  return (
      <>
        ...
        <h1 className='tracking-wider uppercase text-[3.8vw] font-[400] text-[#212121] font-[satoshi]'>feat proj<span className='font-[Migra] font-[400] italic text-[4.2vw]  text-[#603ae1] mr-2'>ec</span>ts</h1>  
    ...
    <div className='flex flex-col justify-center w-[40vw] gap-4 relative'>
        <div className='w-[45vw]  overflow-hidden hover:scale-[0.94] ease-in-out duration-300 cursor-pointer relative group'>
            <img className='overflow-hidden h-3xl w-3xl object-cover' src="/images/SMWZMockup.png" alt="" />
    ...
    <div className='flex flex-col justify-center w-[40vw] gap-4 relative'>
        <div className='w-[45vw]  overflow-hidden hover:scale-[0.94] ease-in-out duration-300 cursor-pointer relative group'>
            <img className='overflow-hidden h-3xl w-3xl object-cover' src="/images/ChatMateMockup.png" alt="" />
            <button className='absolute inset-0 flex items-center justify-center bg-[#212121] bg-opacity-50 text-[#f2f2f2] opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
...
<div className='flex flex-col justify-center w-[45vw] gap-4 mt-[-5%] '>
    <div className='flex flex-col justify-center w-[40vw] gap-4 relative'>
        <div className='w-[45vw]  overflow-hidden hover:scale-[0.94] ease-in-out duration-300 cursor-pointer relative group'>
            <img className='overflow-hidden h-3xl w-3xl object-cover' src="/images/CrypTrackerMockup.png" alt="" />
            <button className='absolute inset-0 flex items-center justify-center bg-[#212121] bg-opacity-50 text-[#f2f2f2] opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
...
<div className='flex items-center justify-end mt-[-5%] px-14'>
    <div className='flex flex-col justify-center w-[40vw] gap-4 relative'>
        <div className='w-[45vw]  overflow-hidden hover:scale-[0.94] ease-in-out duration-300 cursor-pointer relative group'>
            <img className='overflow-hidden h-3xl w-3xl object-cover' src="/images/MuseSphereMockup.png" alt="" />
            <button className='absolute inset-0 flex items-center justify-center bg-[#212121] bg-opacity-50 text-[#f2f2f2] opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
