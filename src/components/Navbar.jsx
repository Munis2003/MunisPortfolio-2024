    ...
    <>
      <div className='max-w-screen-xl px-14 mx-auto pt-10 py-5'>
        <div className='nav-left'>
          <div className='links'>
            <nav className='flex items-center uppercase justify-between text-[12px] font-regular text-[#f2f2f2]/70 font-[satoshi]'>
              ...
              <div className='relative hover:text-[#f2f2f2]' onMouseEnter={() => setDropdownOpen(true)} onMouseLeave={() => setDropdownOpen(false)}>
                ...
                {dropdownOpen && (
                  <div className='absolute ml-[-29%] w-[230%] bg-[#393939]/30 text-[11px] text-[#f2f2f2]/70 py-1 mt-1 font-[satoshi] rounded-xl shadow-lg'>
