  ...
  return (
    <div className='max-w-screen-xl px-14 mx-auto mt-16  flex text-[#f2f2f2]'>
     <div className='w-[50%] mt-[-1%] mb-24'>
        <h1 className='text-[3.3vw] text-[#f2f2f2] mb-[-1%] font-[Satoshi Light]'>Munis Abbas</h1>
        <p className='text-[18px] text-[#f2f2f2] mb-4 font-[Satoshi Light]'>Front-end Developer</p>
        <p className='text-[#f2f2f2]/70 text-[15px] w-[65%] mb-10 font-[Satoshi Light]'>I build inclusive products and create innovative solutions for digital problems.</p>
        ...
        <ul className='flex items-center gap-8 text-[15px] mt-20 font-[Satoshi Light]'>
          <li>Email</li>
          <li>Twitter</li>
          <li>LinkedIn</li>
          <li>Github</li>
     ...
     <p className=' text-[#f2f2f2]/70 mb-2 font-[Satoshi Light]'>I specialize in designing and maintaining responsive websites that prioritize user satisfaction.</p>
        ...
        <p className=' text-[#f2f2f2]/70 mb-20 font-[Satoshi Light]'>I strive to push the boundaries of <br /> web design to deliver seamless user experiences.</p> 
        </div>
        ...
        {data.map((item,index)=>{
          ...
          <div className='ml-5 w-[60%]'>
            ...
            <p className='text-[12px] text-[#f2f2f2]/70 w-[80%] mt-1 font-[Satoshi Light]'>{item.desc}</p>
            <div className='flex items-center text-[#f2f2f2] text-[15px] mt-3'>
              <a target='_blank' href={item.link}><button className='flex items-center gap-3 border-[1.2px] border-[#f2f2f2]/30 py-1 rounded-3xl text-[#f2f2f2]/70 p-2 text-[14px] font-[Satoshi Light]'>View source code <i className="ri-github-fill text-[20px]"></i></button> </a>
              </div>
          </div>
