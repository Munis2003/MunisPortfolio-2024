  ...
  return (
    <>
      <div id='about' ref={ref} className='max-w-screen-xl mx-auto relative'>
        <div className='px-14'>
          <h1 className='absolute left-[87.1%] top-[7%] uppercase text-[12px] font-[Satoshi Medium] text-[#212121]/70 '>Who I <span className='italic text-[14px] text-[#603ae1]/70 font-[Migra] font-[400]'>Am</span></h1>
          <div className='mt-24 pt-12 font-[Satoshi Medium]'>
            ...
            <h1 className='text-[15px] w-[45%] font-[400] font-[Satoshi Medium] text-[#212124] mt-5'>
            ...
            <Link to="/aboutme" onClick={()=>window.scrollTo(0,0)}>
              <button className='font-[Satoshi Medium] border-[1.4px] rounded-[200px] py-2 px-5 mt-5 border-[#212121]/80 text-[13px]  text-[#212121]/80'>
