  ...
  return (
    ...
    <div className='contact hidden lg:block'></div>
     <div className=' max-w-screen-xl px-14 max-[900px]:px-[1em] py-5 pt-3 max-[900px]:py-3 max-[900px]:pt-0  border-t-[1px] bg-[#f2f2f2]'>
        ...
        <a target='_blank' href="mailto: munisabbas2003@gmail.com"><button style={{boxShadow:'0 0 0.15em #603ae1'}}  className='w-10 h-10 max-[900px]:w-4 max-[900px]:h-4 bg-[#603ae1] ml-7 max-[900px]:ml-3 flex items-center justify-center rounded-full text-md text-zinc-900 '><i class="ri-corner-down-right-line max-[900px]:text-[6px] max-[900px]:mt-[1px] max-[900px]:ml-[1px]  text-[16px] ml-[2px] mt-1 text-[#f2f2f2]"></i></button></a>
     </div>
