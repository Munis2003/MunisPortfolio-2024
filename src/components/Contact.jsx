...
const Contact = () => {
  return (
    ...
    <div className='contact hidden lg:block'></div>
     <div className=' max-w-screen-xl px-14 max-[900px]:px-[1em] py-5 pt-3 max-[900px]:pt-0  border-t-[1px] bg-[#f2f2f2]'>
        <Marque/>
        <div className='flex items-center '>  
          <h1 className='font-[Magilio-Regular] text-[10vw] max-[900px]:text-[9vw] text-[#212121]/95'>Let's <span className='footer-span font-[Magilio-Regular] text-[#212121]/85'>C</span>onnect</h1>
        <a target='_blank' href="mailto: munisabbas2003@gmail.com"><button style={{boxShadow:'0 0 0.25em #603ae1'}}  className=' w-10 h-10 max-[900px]:w-4 max-[900px]:h-4 bg-[#603ae1]/90 ml-7 max-[900px]:ml-3 flex items-center justify-center rounded-full text-md text-zinc-900 '><i class="ri-corner-down-right-line mt-1 max-[900px]:text-[6px] max-[900px]:mt-0 max-[900px]:ml-0  text-[18px] text-[#f2f2f2]"></i></button></a>
     </div>
