      ...
      <div className='w-full'>
        <div className='max-w-screen-xl lg:px-14 max-[900px]:px-[1em] mx-auto mt-5 flex items-center justify-center'>
          <div className=''>
            ...
            <div onClick={scrollToAbout} className='flex items-center max-[900px]:gap-2 gap-3 max-[900px]:px-[1.2em] max-[900px]:mb-3  mt-10 ml-[-4.9%] lg-px-14 text-[#f2f2f2]/70 hover:text-[#f2f2f2] cursor-pointer'>
              <button >
            ...
            <div className='flex items-center justify-end gap-6 max-[900px]:mb-3 lg:hidden'>
